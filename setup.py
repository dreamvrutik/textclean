...
setup(
  name = 'textclean',         # How you named your package folder (MyLib)
  packages = ['textclean'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/dreamvrutik/textclean/archive/0.1.tar.gz',    # I explain this later on
  keywords = ['textclean', 'remove punctuation', 'sentences to vectors','vocabulary'],   # Keywords that define your package best
